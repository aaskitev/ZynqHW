...
7. Это может занять несколько минут в зависимости от вашего ПК. Синтез и имплементация происходят в фоне, не пугайтесь, если ничего не появилось. Прогресс отображается в консоли и в верхнем правом углу программы. После окончания *Bitstream Generation* выберите **Open Implemented Design**. Нажмите **OK**. Открытие имплементированного дизайна позволяет экспортировать *Bitstream* в Vitis.
