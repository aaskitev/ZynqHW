...
4. Запустите *Vitis IDE*. Установите Workspace на только что созданную локацию **ZynqDesign.lab6**.
...
5. Создайте новый *Platform Component*, как это делалось в предыдущих работах.  
...
10. В окне *Explorer* раскройте **BRAM_DMA_TEST**, нажмите правой кнопкой мыши на **src** и выберите **Import Sources...**
